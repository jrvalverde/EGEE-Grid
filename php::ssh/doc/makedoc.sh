#!/bin/bash
# $Id: makedoc.sh,v 1.6 2005/05/30 15:29:51 netadmin Exp $ 
...
echo "Generating ssh-sources.tgz..."

rm php-ssh-src.tgz
cd ../..
tar -zcf /tmp/php-ssh-src.tgz php::ssh
mv /tmp/php-ssh-src.tgz php::ssh/doc/.
cd -
