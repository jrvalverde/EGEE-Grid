...
function grock()
{
    ...
    // if we need to. It does not make sense before we have the data available
    pcntl_signal(SIGHUP, "checkpoint");
    //pcntl_signal(SIGINT, "checkpoint");
    //pcntl_signal(SIGQUIT,  "checkpoint");
    //pcntl_signal(SIGABRT, "checkpoint");
