...
####  ENVIRONMENT ####
$ENV{PATH} = "$ENV{PATH}:/opt/glite/bin:/opt/lcg/bin:/opt/globus/bin:/opt/globus/sbin:/opt/edg/bin:/opt/gpt/sbin:/usr/java/j2sdk1.4.2_07/bin:/opt/d-cache/dcap/bin:/opt/d-cache/srm/bin:/opt/edg/bin:/opt/edg/sbin:/opt/edg/bin:/opt/edg/sbin";
...
$ENV{LD_LIBRARY_PATH} = "/opt/glite/lib:/opt/lcg/lib:/opt/globus/lib:/opt/edg/lib:/usr/local/lib:/usr/local/lib:/usr/local/lib:/opt/d-cache/dcap/lib:/opt/d-cache/dcap/lib:/opt/d-cache/dcap/lib:/opt/globus/lib:/opt/edg/lib:/opt/globus/lib:/opt/edg/lib";
...
for ($i=0;$i<$n_recep;$i++){
    ...
    #system "glite-job-status $jobid >> $jobfile/$v_dirs[$i]/test_x.tmp3"; 
...
for ($i=0;$i<$n_recep;$i++){
	...
	#system"glite-job-output -dir $jobfile/$v_dirs[$i]/OUTPUT $job >> $jobfile/$v_dirs[$i]/test_x.tmp2";
