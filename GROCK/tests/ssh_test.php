...
if (isset($debug_persistent_cmd))
{
    ...
    $rmt->ssh_copy_to("./interact.sh", ".", $out);
    
    $p = $rmt->ssh_open_command("./interact.sh");
    echo "after open I got this\n";
    print_r($p);
    sleep(1);
    ...
    echo "\nSending 'SExecClient'\n";
    fwrite($p['std_in'], 'SExecClient\n'); fflush($p['std_in']);
    sleep(1);
    $out = fgets($p['std_out'], 1024);
    echo "\nGot [". $out . "]\n";
