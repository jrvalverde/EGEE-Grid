 ...
 */
require_once '../script/grid_config.php';
require_once '../script/ssh.php';
require_once '../script/grid.php';

$debug_grid=TRUE;
$debug_sexec=TRUE;

# copy these afterwards and reset for actual testing
#   AND delete the copy once testing is done (so no auth info is left)
$user="USER";
$host="GRIDUI.EXAMPLE.NET";
$passwd="UI PASSWORD";
