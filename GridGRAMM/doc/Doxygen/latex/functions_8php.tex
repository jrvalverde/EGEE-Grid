...
Definition at line 245 of file functions.php.\index{functions.php@{functions.php}!close_connection@{close\_\-connection}}
...
Definition at line 101 of file functions.php.\index{functions.php@{functions.php}!create_gr_files@{create\_\-gr\_\-files}}
...
Definition at line 383 of file functions.php.\index{functions.php@{functions.php}!create_working_directory@{create\_\-working\_\-directory}}
...
Definition at line 185 of file functions.php.\index{functions.php@{functions.php}!install_gramm@{install\_\-gramm}}
...
Definition at line 230 of file functions.php.\index{functions.php@{functions.php}!open_connection@{open\_\-connection}}
...
The {\bf Grid}{\rm (p.\,\pageref{classGrid})} User Interface server is the entry point to the {\bf Grid}{\rm (p.\,\pageref{classGrid})} for users and user applications. This is where jobs are launched from.
...
References exit.\index{functions.php@{functions.php}!show_results@{show\_\-results}}
...
References show\_\-structure().\index{functions.php@{functions.php}!show_structure@{show\_\-structure}}
\index{show_structure@{show\_\-structure}!functions.php@{functions.php}}
...
Referenced by show\_\-results().\index{functions.php@{functions.php}!unpack_results@{unpack\_\-results}}
...
Definition at line 406 of file functions.php.\index{functions.php@{functions.php}!upload_user_data@{upload\_\-user\_\-data}}
