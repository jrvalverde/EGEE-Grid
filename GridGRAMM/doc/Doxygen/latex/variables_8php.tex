...
\index{variables.php@{variables.php}!$grid_pass@{\$grid\_\-pass}}
\index{$grid_pass@{\$grid\_\-pass}!variables.php@{variables.php}}
...
Definition at line 33 of file variables.php.\index{variables.php@{variables.php}!$grid_path@{\$grid\_\-path}}
...
Definition at line 45 of file variables.php.\index{variables.php@{variables.php}!$server@{\$server}}
...
Referenced by show\_\-structure().\index{variables.php@{variables.php}!$server_host@{\$server\_\-host}}
\index{$server_host@{\$server\_\-host}!variables.php@{variables.php}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\$server\_\-host = \char`\"{}grid-ui.example.com\char`\"{}}\label{variables_8php_a1}
